 ...
 * @version SVN: $Id$
 */
class AdapterImageMagick extends AdapterAbstract
{
  /**
   * The image resource.
   * @access protected
  ...
  */
  ...
  public function __construct()
  {
    ...
    {
      throw new ImageTransformException('The image processing library ImageMagick is not enabled. See PHP Manual for installation instructions.');
    }
